        ...
        <div class="InfoWrap">
          ...
          <div class="choose">
            ...
            <div class="cartWrap">
              ...
              <div class="add">
                <!-- 这里在加入购物车进行路由跳转之前，发送请求，把你购买产品的信息通过
                请求的方式通知服务器，服务器进行相应的存储 -->
  ...
  methods: {
    ...
    async addShopCar() {
      try {
        ...
        // 这个代码是调用了仓库的addUpdateShopCart函数，这个方法加上asyc，返回一定是Promise
        await this.$store.dispatch("addUpdateShopCart", {
          skuId: this.$route.params.skuid,
          skuNum: this.skuNum,
        });
        // 2、服务器存储成功--->进行路由跳转
        /*  3、在路由跳转的时候还需要将产品的信息带给下一级的路由组件 
        一些简单的数据skuNum，需通过query形式给路由组件传递过去
